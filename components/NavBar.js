...
export default function NavBar({ }) {
    ...
    const [dropdownOpen_game, setDropdownOpen_game] = useState(false)
    ...
    const toggleDropdown_game = () => {
        setDropdownOpen_game(!dropdownOpen_game)
    }
        ...
        <Navbar expand="md" >
            ...
            >
                <Nav navbar >
                    ...
                    <NavItem >
                        <Dropdown isOpen={dropdownOpen_game} toggle={toggleDropdown_game}>
                            <DropdownToggle nav >
                                <button
                                >
                                    응용하기
                            ...
                            <DropdownMenu >
                                ...
                                <div>
                                    ...
                                    <a href='/posts/game-2.2'>2.1 Snake Leaderboard 소개</a> <br></br>
                                    <a href='/posts/game-2.3'>2.2 Snake Leaderboard 참여 방법</a>
